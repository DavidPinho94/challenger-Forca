const palavras = ["dinamarca", "nhoque", "bleach", "açai", "batman","dourado","dinossauro"];
const dicas =["país", "comida", "anime", "fruta", "filme","cor","animal"];
const numero = [Math.floor(Math.random() * palavras.length)];
const palavraSecreta = palavras[numero];
const letrasErradas = [];
const letrasCorretas = [];

document.querySelector("#dica").innerHTML = "A dica é: " + dicas[numero];
